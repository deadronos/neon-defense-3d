...
export const InstancedProjectiles: React.FC = () => {
  ...
  return (
    <instancedMesh ref={setMeshRef('main')} args={[undefined, undefined, 2000]} frustumCulled={false}>
