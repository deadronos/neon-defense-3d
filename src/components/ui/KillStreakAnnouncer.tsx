...
export const KillStreakAnnouncer: React.FC = () => {
  ...
  return (
    <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none z-50 flex flex-col items-center">
      <h1
        className="text-6xl font-black italic text-transparent bg-clip-text bg-gradient-to-b from-white to-cyan-300 stroke-cyan-500 animate-bounce-in drop-shadow-[0_0_15px_rgba(0,255,255,0.8)]"
        style={{
